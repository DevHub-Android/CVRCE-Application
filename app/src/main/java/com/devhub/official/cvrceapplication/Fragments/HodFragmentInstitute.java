...
public class HodFragmentInstitute extends Fragment {
    ...
    private void updateData() {
        class FetchData extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                HodHome activity = (HodHome) getActivity();
                String url = serverAddress.concat("/public/hod_institute_complaints.php").concat("?mentor_id=").concat(mentorId);
