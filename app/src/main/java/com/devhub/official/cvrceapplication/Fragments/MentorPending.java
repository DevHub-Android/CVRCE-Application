...
import com.devhub.official.cvrceapplication.MentorHome;
import com.devhub.official.cvrceapplication.PendingActivity;
...
public class MentorPending extends Fragment {
    ...
    private void updateData() {
        class FetchData extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                PendingActivity activity = (PendingActivity) getActivity();
                String url = serverAddress.concat("/public/PendingComplaints.php").concat("?mentor_id=").concat(activity.getMentorId());
                JsonObjectRequest request0 = new JsonObjectRequest(Request.Method.GET,url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Log.d("check data", "onResponse: " + response);
