...
public class PrinciFragmentExamHostel extends Fragment {
    ...
    public PrinciFragmentExamHostel() {
    ...
    private void updateData() {
        class FetchData extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                PrincipalHome activity = (PrincipalHome) getActivity();
                String url = serverAddress.concat("/public/princi_hostel_complaints.php");
