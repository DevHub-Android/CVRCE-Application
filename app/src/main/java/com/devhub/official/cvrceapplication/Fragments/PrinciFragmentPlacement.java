...
public class PrinciFragmentPlacement extends Fragment {
    ...
    public PrinciFragmentPlacement() {
    ...
    private void updateData() {
        class FetchData extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                PrincipalHome activity = (PrincipalHome) getActivity();
                String url = serverAddress.concat("/public/princi_placement_complaints.php");
