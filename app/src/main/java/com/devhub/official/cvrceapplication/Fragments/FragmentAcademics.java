...
public class FragmentAcademics extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        complaints_data =  activity.getAcademicsComplains();
    ...
    private void updateData() {
        class FetchData extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                String url = serverAddress.concat("/public/academics_complaints.php?user_id="+ SharedPrefManager.getInstance(getActivity()).getUser().getRegid());
                Log.e("food_url",url);
