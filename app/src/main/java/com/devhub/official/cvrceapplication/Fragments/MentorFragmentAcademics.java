...
public class MentorFragmentAcademics extends Fragment {
    ...
    public MentorFragmentAcademics() {
    ...
    private void updateData() {
        class FetchData extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                MentorHome activity = (MentorHome) getActivity();
                String url = serverAddress.concat("/public/mentor_academics_complaints.php").concat("?mentor_id=").concat(activity.getMentorId());
