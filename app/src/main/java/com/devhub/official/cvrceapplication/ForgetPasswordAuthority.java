...
public class ForgetPasswordAuthority extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forget_password_authority);
        ...
        if(getIntent().getStringExtra("type").equals("mentor"))
        {
          server_url = URLs.SERVER_ADDR+"/public/forget_password_faculty.php";
            ...
            server_url = URLs.SERVER_ADDR+"/public/forget_password_authority.php";
            ...
            public void onClick(View view) {
                ...
                class Asynck extends AsyncTask<Void,Void,Void> {
                    ...
                    protected Void doInBackground(Void... voids) {
                        ...
                        {
                            regNo.requestFocus();
                            regNo.setError("Please Provide Your Email Id!");
                        }else {
