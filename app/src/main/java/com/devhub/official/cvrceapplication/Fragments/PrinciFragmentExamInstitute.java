...
import com.devhub.official.cvrceapplication.PrincipalHome;
import com.devhub.official.cvrceapplication.R;
import com.devhub.official.cvrceapplication.URLs;

import org.json.JSONObject;

public class PrinciFragmentExamInstitute extends Fragment {
    ...
    public PrinciFragmentExamInstitute() {
    ...
    private void updateData() {
        class FetchData extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                PrincipalHome activity = (PrincipalHome) getActivity();
                String url = serverAddress.concat("/public/princi_institute_complaints.php");
